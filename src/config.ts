...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "jinyijiang", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"此间所记，并非鸿篇巨制，亦非功利之报",
				"只是一隅安然自处的素笺，收录着行旅中的细微观想，日常里的清明感悟",
				"愿此文字，如清晨之露，映照瞬间的珍贵；如高山之风，带来片刻的清醒与平和",
			],
			typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.395718.xyz/.netlify/functions/twikoo",
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_0UBX3MRdDauDKCJDJt5Gqdd5wxr6xOUn", // API密钥优先从环境变量读取，否则使用配置文件中的值
